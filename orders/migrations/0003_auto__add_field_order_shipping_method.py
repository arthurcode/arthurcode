...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_method'
        db.add_column('orders_order', 'shipping_method',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_method'
        db.delete_column('orders_order', 'shipping_method')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'shipping_method': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
