...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomerProfile.on_mailing_list'
        db.delete_column('accounts_customerprofile', 'on_mailing_list')

        # Adding unique constraint on 'PublicProfile', fields ['username']
        db.create_unique('accounts_publicprofile', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'PublicProfile', fields ['username']
        db.delete_unique('accounts_publicprofile', ['username'])

        # Adding field 'CustomerProfile.on_mailing_list'
        db.add_column('accounts_customerprofile', 'on_mailing_list',
