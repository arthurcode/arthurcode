...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductCartItem'
        db.create_table('cart_productcartitem', (
        ...
        db.send_create_signal('cart', ['ProductCartItem'])

        # Deleting field 'CartItem.item'
        db.delete_column('cart_cartitem', 'item_id')


    def backwards(self, orm):
        # Deleting model 'ProductCartItem'
        db.delete_table('cart_productcartitem')

        # Adding field 'CartItem.item'
        db.add_column('cart_cartitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.ProductInstance']),
                      keep_default=False)
