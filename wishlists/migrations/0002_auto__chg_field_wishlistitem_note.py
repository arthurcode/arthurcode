...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WishListItem.note'
        db.alter_column('wishlists_wishlistitem', 'note', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'WishListItem.note'
        db.alter_column('wishlists_wishlistitem', 'note', self.gf('django.db.models.fields.CharField')(default=None, max_length=75))
