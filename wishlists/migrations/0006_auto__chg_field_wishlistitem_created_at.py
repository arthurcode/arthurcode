...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WishListItem.created_at'
        db.alter_column('wishlists_wishlistitem', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'WishListItem.created_at'
        db.alter_column('wishlists_wishlistitem', 'created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'wishlists.wishlistitem': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'WishListItem'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'wishlists.wishlistitemtocartitem': {
            ...
            'cart_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wishlist_links'", 'to': "orm['cart.CartItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
