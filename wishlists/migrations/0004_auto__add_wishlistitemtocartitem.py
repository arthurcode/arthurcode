...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WishListItemToCartItem'
        db.create_table('wishlists_wishlistitemtocartitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wishlist_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wishlists.WishListItem'])),
            ('cart_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.CartItem'])),
        ))
        db.send_create_signal('wishlists', ['WishListItemToCartItem'])


    def backwards(self, orm):
        # Deleting model 'WishListItemToCartItem'
        db.delete_table('wishlists_wishlistitemtocartitem')
