...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.country_of_origin'
        db.alter_column('catalogue_product', 'country_of_origin', self.gf('django_countries.fields.CountryField')(default='CA', max_length=2))

    def backwards(self, orm):

        # Changing field 'Product.country_of_origin'
        db.alter_column('catalogue_product', 'country_of_origin', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))
    ...
    models = {
        ...
        'catalogue.dimension': {
            'Meta': {'ordering': "['id']", 'object_name': 'Dimension'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dimensions'", 'to': "orm['catalogue.Product']"}),
