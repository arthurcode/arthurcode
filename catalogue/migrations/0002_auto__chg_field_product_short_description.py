...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_product', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=700))

    def backwards(self, orm):

        # Changing field 'Product.short_description'
        db.alter_column('catalogue_product', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=500))
