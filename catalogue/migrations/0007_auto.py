...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Product', fields ['is_active']
        db.create_index('catalogue_product', ['is_active'])


    def backwards(self, orm):
        # Removing index on 'Product', fields ['is_active']
        db.delete_index('catalogue_product', ['is_active'])
