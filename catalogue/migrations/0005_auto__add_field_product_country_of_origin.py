...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.country_of_origin'
        db.add_column('catalogue_product', 'country_of_origin',
                      self.gf('django_countries.fields.CountryField')(max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.country_of_origin'
        db.delete_column('catalogue_product', 'country_of_origin')
